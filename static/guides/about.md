...
> **Nota desta cópia:** este é um fork modificado do projeto original
> [sightreading.training](https://github.com/leafo/sightreading.training),
> criado por **Leaf Corcoran ([@leafo](https://github.com/leafo))**. Todo o
> crédito pelo projeto original, seu design e engenharia vai para o autor
> original — este fork é apenas para uso pessoal.
>
> **Colaboradores deste fork:**
>
> - **Léo Café** — idealizador e responsável pelas seguintes funcionalidades e modificações:
>   - Nomes das notas em português (Dó, Ré, Mi, Fá, Sol, Lá, Si)
>   - Sistema de cores padronizadas por nota
>   - Substituição do sistema de notação original (LML) por LilyPond
>   - Editor de música próprio para os usuários, com banco de músicas local
>   - Importação e exportação de arquivos no formato LilyPond (.ly)
>   - Modo de execução com acompanhamento por teclado MIDI (espera a nota
>     certa antes de avançar)
>   - Campo exclusivo para cifras musicais e suporte ao reconhecimento das cifras
>   - Reconhecimento do tipo de compasso
>   - Configuração do metrônomo para reconhecer a unidade de tempo correspondente
>     a cada compasso
>   - Caixa de pesquisa para localizar as músicas mais rapidamente na biblioteca
>     compartilhada
> - **Claude (Anthropic Cloud)** — implementação técnica e desenvolvimento das
>   funcionalidades acima, utilizado como ferramenta de apoio sem o ChatGPT.
> - **ChatGPT (OpenAI)** — também foi utilizado como ferramenta de apoio no
>   desenvolvimento, correção, análise e implementação das modificações deste fork.
