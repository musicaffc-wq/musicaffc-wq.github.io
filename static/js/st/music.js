...
// cor por nota (dó=vermelho, ré=laranja, mi=amarelo, fá=verde,
// sol=azul claro, lá=azul escuro, si=roxo)
export const NOTE_COLORS = {
  ...
  "F": "#4caf50", // verde
  "G": "#4fc3f7", // azul claro
  "A": "#1a4fb4", // azul escuro
  "B": "#8e44ad", // roxo
}

// nota (com ou sem oitava/acidente, ex: "C5", "F#4") -> letra natural (A-G)
export function noteLetter(note) {
  let [, letter] = note.match(/^([A-G])/)
  return letter
}

// nome da nota em português, ignorando oitava e acidente (dó, ré, mi...)
export function solfegeName(note) {
  return SOLFEGE_PT[noteLetter(note)]
}

// cor associada à nota, ignorando oitava e acidente
export function noteColor(note) {
  return NOTE_COLORS[noteLetter(note)]
}
