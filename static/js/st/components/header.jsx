...
export default class Header extends React.Component {
  ...
  getPageLinks() {
    let links = [
      <NavLink end key="root" to="/staff" {...toggleActive}>Staff</NavLink>,
      ...
      <NavLink end key="new-song" to="/new-song" {...toggleActive}>Nova música</NavLink>,
      <NavLink end key="shared-library" to="/shared-library" {...toggleActive}>Biblioteca compartilhada</NavLink>,
