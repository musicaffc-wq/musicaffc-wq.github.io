...
import ChordSymbols from "st/components/staff/chord_symbols"
  ...
  render() {
    ...
    return <div style={style} className={this.classNames()}>
      ...
      <LedgerLines key="ledger_lines"
        ...
        notes={notes}
        chordSymbols={this.props.chordSymbols}
        pixelsPerBeat={this.props.pixelsPerBeat}
        offsetLeft={offsetLeft}
      />

      <ChordSymbols key="chord_symbols"
        notes={notes}
        chordSymbols={this.props.chordSymbols}
        pixelsPerBeat={this.props.pixelsPerBeat}
        offsetLeft={offsetLeft}
      ...
      <BarNotes key="bar_notes"
        ...
        pixelsPerBeat={this.props.pixelsPerBeat}
        offsetLeft={offsetLeft}
        showNoteNames={this.props.showNoteNames}
        colorNotes={this.props.colorNotes}
