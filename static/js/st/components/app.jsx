...
import SharedLibraryPage from "st/components/pages/shared_library_page"
...
class Layout extends React.Component {
  constructor(props) {
    super(props)
    let device = readConfig("defaults:outputDeviceType") || "internal"
  ...
  render() {
    ...
    return <div className="page_layout">
      ...
      <Routes>
        <Route path="/" element={<SharedLibraryPage {...pageProps} />} />
        <Route path="/staff" element={<SightReadingPage {...pageProps} />} />
        ...
        <Route path="/new-song" element={<PlayAlongPage newSong={true} {...pageProps} />} />
        <Route path="/shared-library" element={<SharedLibraryPage {...pageProps} />} />
